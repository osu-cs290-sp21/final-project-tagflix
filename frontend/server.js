...
app.get("/page/:num", (req, res) => {
  ...
  const url =
    "https://us-west-2.aws.webhooks.mongodb-realm.com/api/client/v2.0/app/tagflix-gprxr/service/movies/incoming_webhook/movies?page=" +
    queryNum.toString();
...
app.get("/tagPage", (req, res) => {
  //pulls all tags and displays on page
  const url =
    "https://us-west-2.aws.webhooks.mongodb-realm.com/api/client/v2.0/app/tagflix-gprxr/service/movies/incoming_webhook/tags";
  axios
    .get(url)
    .then(async (response) => {
      var homeContext;
      ...
      tagsArray.forEach((tag) => {
        const tagStuff = {
          url:
            "https://us-west-2.aws.webhooks.mongodb-realm.com/api/client/v2.0/app/tagflix-gprxr/service/movies/incoming_webhook/movies?tag=" +
            tag,
          tag: tag,
        };
...
app.get("/titles/:title", (req, res) => {
  ...
  const url =
    "https://us-west-2.aws.webhooks.mongodb-realm.com/api/client/v2.0/app/tagflix-gprxr/service/movies/incoming_webhook/movies?title=" +
    que;
  axios.get(url).then((data) => {
    var movieArray = data.data.movies;
    ...
    var homeContext = [];
    for (var i = 0; i < movieArray.length; i++) {
      if (movieArray[i].title.search(que) != -1 && movieArray[i].poster != null)
        continue;
      var movieObj = {
...
app.get("/IMDB/:rating", (req, res) => {
  ...
  const url =
    "https://us-west-2.aws.webhooks.mongodb-realm.com/api/client/v2.0/app/tagflix-gprxr/service/movies/incoming_webhook/movies?IMDB=" +
    que.toString();
  axios.get(url).then((data) => {
    var movieArray = data.data.movies;
    var homeContext = [];
...
app.get("/Year_Range/:years", (req, res) => {
  ...
  const url =
    "https://us-west-2.aws.webhooks.mongodb-realm.com/api/client/v2.0/app/tagflix-gprxr/service/movies/incoming_webhook/movies?year_range=" +
    que;
...
app.get("/genres/:genre", (req, res) => {
  ...
  const url =
    "https://us-west-2.aws.webhooks.mongodb-realm.com/api/client/v2.0/app/tagflix-gprxr/service/movies/incoming_webhook/movies?genre=" +
    que;
  axios.get(url).then((data) => {
    var movieArray = data.data.movies;
    que.toString();
...
app.get("/movies/:id", (req, res) => {
  ...
  const url =
    "https://us-west-2.aws.webhooks.mongodb-realm.com/api/client/v2.0/app/tagflix-gprxr/service/movies/incoming_webhook/movie?id=" +
    movieId;
  axios.get(url).then((data) => {
    var movieObj = {
      posterUrl: data.data.poster,
      rated: data.data.rated,
      imdb: data.data.imdb.rating.$numberDouble,
